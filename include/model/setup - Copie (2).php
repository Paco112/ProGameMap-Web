			...
			if($listing_maps)
			{
				...
				foreach($listing_maps as $map)
				{
					...
					if($affiche == 1)
					{
						...
						for($ii=1;$ii<=5;$ii++)
						{
							$etoile .= '<img id="'.$map['id'].'_'.$ii.'" src="'.$lien.'public/images/Etoile_ON.png">';
						}
						...
						$liste_maps .= "<div class=\"box_maps\" id=\"m_".$map['id']."\" name=\"m_".$map['id']."\" style=\"float:left; padding-top:5px; height:211px; width:194px; background-image:url('".$lien."public/images/box_opacity2.png'); background-repeat:no-repeat; color:#FFF;\">"
									...
									. "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">"
									. "<tr>"
									. "<td colspan=\"2\" style=\"padding-left:10px; color:#FFF;\"><strong>".$map['name']."</strong></td>"
									. "</tr>"
									. "<tr>"
									...
									. "<td style=\"text-align:right;\">14 Votes</td>"
									. "</tr>"
									. "<tr>"
									. "<td style=\"padding-left:10px; font-size:11px;\">OBJ/TDM/FFA/RB</td>"
									. "<td style=\"text-align:right;\">".$map['stats_dl']."</td>"
									. "</tr>"
									. "<tr>"
									. "<td colspan=\"2\" style=\"text-align:center; padding-left:22px;\"><a id=\"".$map['id']."\" name=\"".$map['id']."\" class=\"".$p_class."\" href=\"".$lien.Plink($param,3,1,strtolower($game['name']))."\" style=\"text-decoration: none; color:#FFF;\"><strong>".$p_view."</strong></a></td>"
									. "</tr>"
									. "</table>"
									. "</div>"
									. "</div>";									
			...
			else
			{
				...
				if($param[4] != CART)
				{
					...
					{						
						...
						$paging = '<table border="0" cellspacing="0" cellpadding="0" id="pagging">'
							   . '<tr>'
							   . '<td><a href="'.$lien.Plink_name($param_name,'page',$n_prec).'"><img src="'.$lien.'public/images/fleche_g.png" width="19" height="18" alt="" border="0" /></a></td>'
							   . '<td>'.$view_page.'</td>'
							   . '<td><a href="'.$lien.Plink_name($param_name,'page',$n_suiv).'"><img src="'.$lien.'public/images/fleche_d.png" width="19" height="18" alt="" border="0" /></a></td>'
							   . '</tr>'
							   . '</table>';
