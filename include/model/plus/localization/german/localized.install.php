<?php
// File : german/localized.install.php - plus version (06.09.2007 - rev.2)
...
define("L_DB_HINT1","Datenbank");
define("L_DB_HINT2","existiert nicht und ich kann diese nicht anlegen!");
...
define("L_INST_FOR","Installation für");
define("L_INST_VER","Version:");
define("L_INST_PAG","Setup - Seite");
define("L_INST_OF","von");
define("L_P0_HINT1","Willkommen bei unserer Installation für");
...
define("L_P2_HINT2","Die Konfigurationsdatei hat keine Schreibrechte. Um der Datei die Schreibrechte zu geben, benutzen Sie ein beliebiges FTP-Programm (z.B. Total Commander) um Verbindung zum Server aufzubauen und ändern Sie die Dateirechte der Datei \"config.lib.php\" in dem Verzeichnis config mittels CHMOD 0666. Wenn Sie nicht wissen, wie Sie diese Dateirechte ändern oder falls Sie die Dateirechte nicht ändern möchten, füllen Sie bitte das Formular unten aus und klicken auf \"".L_BTN1."\".");
...
define("L_P1_OP02","Upgrade von phpMyChat Plus 1.90");
define("L_P1_OP03","Upgrade von phpMyChat Plus v1.8");
define("L_P1_OP04","Upgrade von phpMyChat Plus v1.7");
define("L_P1_OP05","Upgrade von phpMyChat Plus v1.0-v1.6");
define("L_P1_OP06","Upgrade von phpMyChat Standard 0.14-0.15");
define("L_P1_OP07","Upgrade von phpMyChat Standard 0.13");
define("L_P1_OP08","Upgrade von phpMyChat Standard < 0.12");
