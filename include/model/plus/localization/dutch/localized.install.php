<?php
// File : dutch/localized.install.php - plus version (06.09.2007 - rev.2)
...
define("L_DB_HINT2","bestaat niet en kan ik niet maken!");
...
define("L_INST_FOR","Installer voor");
define("L_INST_VER","Versie:");
define("L_INST_PAG","Setup - Pagina");
define("L_INST_OF","van");
define("L_P0_HINT1","Welkom bij onze installatie van");
...
define("L_P2_HINT2","De configuratie file is niet overschrijfbaar. Om deze te veranderen, gebruik een FTP-program (e.g. Total Commander) om verbinding te krijgen met je server en CHMOD 0666 to \"config.lib.php\" file in de configuratie map). Als je niet weet hoe dit moet of als je de permissie´s niet wilt veranderen van deze file, vul dan de formulier hieronder in en klik op \"".L_BTN1."\".");
...
define("L_P1_OP02","Upgrade van phpMyChat Plus 1.90");
define("L_P1_OP03","Upgrade van phpMyChat Plus v1.8");
define("L_P1_OP04","Upgrade van phpMyChat Plus v1.7");
define("L_P1_OP05","Upgrade van phpMyChat Plus v1.0-v1.6");
define("L_P1_OP06","Upgrade van phpMyChat Standard 0.14-0.15");
define("L_P1_OP07","Upgrade van phpMyChat Standard 0.13");
define("L_P1_OP08","Upgrade van phpMyChat Standard < 0.12");
