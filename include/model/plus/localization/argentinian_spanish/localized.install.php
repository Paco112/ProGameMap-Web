<?php
// File : argentinian_spanish/localized.install.php - plus version (06.09.2007 - rev.2)
...
define("L_INST_OF","de");
define("L_P0_HINT1","Bienvenido a nuestro instalador para");
...
define("L_P2_HINT2","El archivo de configuración es solo de lectura. Para permitir su escritura, use cualquier programa FTP (ej. Total Commander) para conectar su servidor y aplicar CHMOD 0666 al archivo \"config.lib.php\" en la carpeta config). Si no sabés cómo hacerlo o si no querés cambiar los permisos de este archivo, por favor completá el siguiente form y presioná \"".L_BTN1."\".");
...
define("L_P1_OP02","Actualizar desde phpMyChat Plus 1.90");
define("L_P1_OP03","Actualizar desde phpMyChat Plus v1.8");
define("L_P1_OP04","Actualizar desde phpMyChat Plus v1.7");
define("L_P1_OP05","Actualizar desde phpMyChat Plus v1.0-v1.6");
define("L_P1_OP06","Actualizar desde phpMyChat Standard 0.14-0.15");
define("L_P1_OP07","Actualizar desde phpMyChat Standard 0.13");
define("L_P1_OP08","Actualizar desde phpMyChat Standard < 0.12");
