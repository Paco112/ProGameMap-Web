<?php
// File : english/localized.install.php - plus version (06.09.2007 - rev.2)
...
define("L_DB_HINT2","does not exists and I can not create it!");
...
define("L_INST_FOR","Installer for");
define("L_INST_VER","Version:");
define("L_INST_PAG","Setup - Page");
define("L_INST_OF","of");
define("L_P0_HINT1","Welcome to our installer for");
define("L_P0_HINT2","Please enter your ftp login data bellow.");
define("L_P1_HINT1","This setup will guide you through the installation process.<br />Please select your installation type bellow.");
define("L_P1_HINT2","Please select what type of installation is this:");
define("L_P1_HINT3","The FTP - data you provided seem to be wrong. The setup cannot continue. Please go back and correct the errors. This are the errors:");
...
define("L_P2_HINT2","The config file is not writeable. To make it writeable, use any FTP-program (e.g. Total Commander) to connect to your server and apply CHMOD 0666 to \"config.lib.php\" file in the config folder). If you don’t know how to do this or if you don’t like to change the permissions of this file, please fill out the form bellow and click \"".L_BTN1."\".");
...
define("L_P3_HINT2","Here are your configuration results to be pasted into the \"config/config.lib.php\" file. Please select all the text from the message-box bellow, copy it and paste it in your prefered text-editor (e.g. Notepad++). Save the file as config.lib.php (make sure the type is All types not Text document) and put the file up on your ftp-server in the \"config\" directory.");
...
define("L_P1_OP02","Upgrade from phpMyChat Plus 1.90");
define("L_P1_OP03","Upgrade from phpMyChat Plus v1.8");
define("L_P1_OP04","Upgrade from phpMyChat Plus v1.7");
define("L_P1_OP05","Upgrade from phpMyChat Plus v1.0-v1.6");
define("L_P1_OP06","Upgrade from phpMyChat Standard 0.14-0.15");
define("L_P1_OP07","Upgrade from phpMyChat Standard 0.13");
define("L_P1_OP08","Upgrade from phpMyChat Standard < 0.12");
...
define("L_P4_FORM2","Optionally, you can also install a bot (robot, virtual user) for your chat, so it can add some fun to your rooms. You can do this later, but this is the best time to do it. If you click on the link bellow, please do not stop the script from running in the new popup window!");
