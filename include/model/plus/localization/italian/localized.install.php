<?php
// File : italian/localized.install.php - plus version (06.09.2007 - rev.2)
...
define("L_DB_HINT2","non esiste e non posso crearlo!");
...
define("L_PASS_ERROR3","La passwrod e la verifica password non corrispondono.<br />Per cortesia torna indietro e riscrivi le passwrod!");
...
define("L_INST_FOR","Installazione di");
define("L_INST_VER","Versione:");
define("L_INST_PAG","Setup - Pagina");
define("L_INST_OF","di");
define("L_P0_HINT1","Benvenuto nell’installazione di");
...
define("L_P1_OP02","Aggiorna da phpMyChat Plus 1.90");
define("L_P1_OP03","Aggiorna da phpMyChat Plus v1.8");
define("L_P1_OP04","Aggiorna da phpMyChat Plus v1.7");
define("L_P1_OP05","Aggiorna da phpMyChat Plus v1.0-v1.6");
define("L_P1_OP06","Aggiorna da phpMyChat Standard 0.14-0.15");
define("L_P1_OP07","Aggiorna da phpMyChat Standard 0.13");
define("L_P1_OP08","Aggiorna da phpMyChat Standard < 0.12");
