...
<center>
<br /><br /><br /><br /><br /><br /><center><font size="+2"><b><?php echo((C_CHAT_NAME != "") ? C_CHAT_NAME : APP_NAME); ?> is closed.<br /><br /><font color=green>Our open schedule is<?php if (C_OPEN_DAILY) echo(" daily,"); else { C_OPEN_MONDAY ? " ".L_MONDAY."," : ""; C_OPEN_TUESDAY ? " ".L_TUESDAY."," : ""; C_OPEN_WEDNESDAY ? " ".L_WEDNESDAY."," : ""; C_OPEN_THURSDAY ? " ".L_THURSDAY."," : ""; C_OPEN_FRIDAY ? " ".L_FRIDAY."," : ""; C_OPEN_SATURDAY ? " ".L_SATURDAY."," : ""; C_OPEN_SUNDAY ? " ".L_SUNDAY."," : ""; }; ?><br />from <?php echo(C_OPEN_TIME_BEGIN); ?> to <?php echo(C_OPEN_TIME_END); ?>.</font><br />
