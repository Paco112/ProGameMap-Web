...
01.04.2009 - f8:
- the input frame error fixed (bot/subs.inc file path referenced correctly now);
- counter won't increase for the same user's visit within an hour;
- buzzes_popup.php and links.php charset fixes;
02.01.2008 - f7:
