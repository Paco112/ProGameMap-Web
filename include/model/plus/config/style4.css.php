...
// "DarkSlateBlue & indigo" skin for phpMyChat plus - by Bluntdog
...
The variable color: <?php echo($CD); ?>  will make time, sender and message color have the same default color defined bellow.*/
	...
	$CD = "indigo";			//default messages color (this color should be chosen in the Admin panel tab, filter color of this rooms' skin)
