...
<dl>
	<dt><label for="jab_password"><?php echo ((isset($this->_rootref['L_JAB_PASSWORD'])) ? $this->_rootref['L_JAB_PASSWORD'] : ((isset($user->lang['JAB_PASSWORD'])) ? $user->lang['JAB_PASSWORD'] : '{ JAB_PASSWORD }')); ?>:</label></dt>
