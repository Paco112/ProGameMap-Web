...
<?php if (! $this->_rootref['S_ADMIN_AUTH'] && $this->_rootref['S_REGISTER_ENABLED']) {  ?>
	<div class="panel">
		...
		<div class="content">
			...
			<hr class="dashed" />
			<p><a href="http://www.progamemap.com/fr/compte/nouveau/" class="button2"><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a></p>
		</div>
